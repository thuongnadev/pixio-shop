          ...
          <div class="col-xl-6 col-md-6">
            <div class="dz-product-detail sticky-top">
              <Lightgallery :settings="{ speed: 500, plugins: [lgThumbnail, lgZoom], selector: '.lg-item' }" class="swiper-btn-center-lr">
                <Swiper class="swiper product-gallery-swiper2" :modules="[Thumbs]" :thumbs="{ swiper: thumbsSwiper }">
              ...
              <div class="dz-content">
                <div class="dz-content-footer">
                  <div class="dz-content-start">
                    ...
                    <h4 class="title mb-1">Women Red &amp; White Striped Crepe Top</h4>
                ...
                <p class="para-text">
                  This comfortable cotton crop-top features the Divi Engine logo on the front expressing how easy “data Divi Engine life” is. It is
                  the perfect tee for any occasion.
                </p>
                ...
                <div class="btn-group cart-btn">
                  ...
                  <RouterLink to="/shop-wishlist" class="btn btn-outline-secondary btn-icon">
                ...
                <div class="row">
                  <div class="col-lg-6 m-lg-b0 m-md-b30">
                    <div class="section-head style-2 d-block">
                      ...
                      <p>
                        Designed for superior child comfort, OneFit™ provides extra rear-facing legroom and multiple recline options in every mode of
                        use. With the widest range of height adjustments, the easy-adjust headrest system adjusts with the harness to grow with your
                        child. OneFit™ accommodates tiny passengers from the very start with a removable head and body support insert for newborns
                        weighing 5-11 lbs.
                      </p>
                    </div>
                    ...
                    <div class="product-media row g-xl-4 g-2 m-b40">
                      <div class="col-md-3 col-3 col-sm-3 product-media-inner">
                        <RouterLink to="/shop-list" class="dz-media">
                          <img src="../../assets/images/products/dress1.png" alt="/" />
                        </RouterLink>
                      </div>
                      <div class="col-md-3 col-3 col-sm-3 product-media-inner">
                        <RouterLink to="/shop-list" class="dz-media">
                          <img src="../../assets/images/products/dress2.png" alt="/" />
                        </RouterLink>
                      </div>
                      <div class="col-md-3 col-3 col-sm-3 product-media-inner">
                        <RouterLink to="/shop-list" class="dz-media">
                          <img src="../../assets/images/products/dress3.png" alt="/" />
                        </RouterLink>
                      </div>
                      <div class="col-md-3 col-3 col-sm-3 product-media-inner">
                        <RouterLink to="/shop-list" class="dz-media">
                          <img src="../../assets/images/products/dress4.png" alt="/" />
                        </RouterLink>
                      </div>
                    </div>
                    <div class="product-info">
                      ...
                      <div class="product-info-inner">
                        ...
                        <p class="info-text">
                          The OneFit ClearTex All-In-One Car Seat is produced without the use of intentionally added fire retardant chemical
                          treatments, PFAS, BPA and phthalates.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="row">
                      <div class="col-lg-6 col-md-6 m-sm-b20 m-b30">
                        <RouterLink to="/shop-standard" class="about-product-wrapper">
                    ...
                    <div class="dz-product-media dz-media rounded">
                      <img src="../../assets/images/shop/product-details/product-style-1/product-details-1.png" alt="/" />
                    </div>
                  </div>
                </div>
              </div>
