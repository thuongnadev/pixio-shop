        ...
        <div class="row">
          ...
          <section class="col-xl-9 account-wrapper">
            <div class="account-card">
              <div class="m-b30">
                <p>
                  Hello <strong class="text-black">John Doe</strong> (not <strong class="text-black">John Doe</strong>?
                  <RouterLink to="/login" class="text-underline">Log out</RouterLink>)
                </p>
                <p>
                  From your account dashboard you can view your <RouterLink to="/account-orders" class="text-underline">recent orders</RouterLink>,
                  manage your <RouterLink to="/account-address" class="text-underline">shipping and billing addresses</RouterLink>, and
                  <RouterLink to="/account-profile" class="text-underline">edit your password and account details</RouterLink>.
                </p>
              </div>
              <div class="row g-4">
                <div class="col-md-4">
                ...
                <div class="col-xl-8">
                  <div class="sales-chart-wraper">
                    <div id="handleSalesChart">
                      <VueApexCharts :series="state.series" :options="state.chartOptions" />
                    </div>
                  </div>
                </div>
                <div class="col-xl-4">
                  <div class="card countries-card px-3 pt-3 pb-2 mb-2">
                    ...
                    <ul>
                      ...
                      <li>
                        <div class="thumb-detail">
                          <img src="../../assets/images/country/pic4.png" alt="" />
                          <span>Canada</span>
                        </div>
                      ...
                      <li>
                        <div class="thumb-detail">
                          <img src="../../assets/images/country/pic5.png" alt="" />
                          <span>Brazil</span>
                        </div>
                      ...
                      <li class="border-bottom-0">
                        <div class="thumb-detail">
                          <img src="../../assets/images/country/pic6.png" alt="" />
                          <span>Jordan</span>
                        </div>
