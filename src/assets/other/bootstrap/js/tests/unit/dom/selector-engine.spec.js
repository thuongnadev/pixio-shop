...
describe('SelectorEngine', () => {
  ...
  describe('find', () => {
    ...
    it('should handle :scope selectors', () => {
      fixtureEl.innerHTML = [
        ...
        '  <li></li>',
        '  <li>',
        '    <RouterLink href="#" class="active">link</a>',
        '  </li>',
        '  <li></li>',
        '</ul>'
      ].join('')
  ...
  describe('getSelectorFromElement', () => {
    ...
    it('should get selector from href if no data-bs-target set', () => {
      fixtureEl.innerHTML = [
        '<RouterLink id="test" href=".target"></a>',
        '<div class="target"></div>'
      ].join('')
    ...
    it('should get selector from href if data-bs-target equal to #', () => {
      fixtureEl.innerHTML = [
        '<RouterLink id="test" data-bs-target="#" href=".target"></a>',
        '<div class="target"></div>'
      ].join('')
    ...
    it('should return null if a selector from a href is a url without an anchor', () => {
      fixtureEl.innerHTML = [
        '<RouterLink id="test" data-bs-target="#" href="foo/bar.html"></a>',
        '<div class="target"></div>'
      ].join('')
    ...
    it('should return the anchor if a selector from a href is a url', () => {
      fixtureEl.innerHTML = [
        '<RouterLink id="test" data-bs-target="#" href="foo/bar.html#target"></a>',
        '<div id="target"></div>'
      ].join('')
    ...
    it('should return null if selector not found', () => {
      fixtureEl.innerHTML = '<RouterLink id="test" href=".target"></a>'
