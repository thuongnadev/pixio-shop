    ...
    it('should create carousel and go to the next slide on click (using links as controls)', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '    <div class="carousel-item">item 3</div>',
          '  </div>',
          '  <RouterLink class="carousel-control-prev" href="#myCarousel" role="button" data-bs-slide="prev"></a>',
          '  <RouterLink id="next" class="carousel-control-next" href="#myCarousel" role="button" data-bs-slide="next"></a>',
          '</div>'
        ].join('')
