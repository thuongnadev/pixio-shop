...
describe('Modal', () => {
  ...
  describe('data-api', () => {
    ...
    it('should prevent default when the trigger is <RouterLink> or <RouterLinkrea>', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<RouterLink data-bs-toggle="modal" href="#" data-bs-target="#exampleModal"></a>',
          '<div id="exampleModal" class="modal"><div class="modal-dialog"></div></div>'
        ].join('')
    ...
    it('should not prevent default when a click occurred on data-bs-dismiss="modal" where tagName is DIFFERENT than <RouterLink> or <RouterLinkrea>', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div class="modal">',
          '  <div class="modal-dialog">',
    ...
    it('should prevent default when a click occurred on data-bs-dismiss="modal" where tagName is <RouterLink> or <RouterLinkrea>', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div class="modal">',
          '  <div class="modal-dialog">',
          '    <RouterLink type="button" data-bs-dismiss="modal"></a>',
          '  </div>',
          '</div>'
        ].join('')
    ...
    it('should not focus the trigger if the modal is not visible', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<RouterLink data-bs-toggle="modal" href="#" data-bs-target="#exampleModal" style="display: none;"></a>',
