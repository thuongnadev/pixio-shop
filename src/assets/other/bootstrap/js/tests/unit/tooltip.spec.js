...
describe('Tooltip', () => {
  ...
  describe('constructor', () => {
    it('should take care of element either passed as a CSS selector or DOM element', () => {
      fixtureEl.innerHTML = '<RouterLink href="#" id="tooltipEl" rel="tooltip" title="Nice and short title"></a>'
    ...
    it('should not take care of disallowed data attributes', () => {
      fixtureEl.innerHTML = '<RouterLink href="#" rel="tooltip" data-bs-sanitize="false" title="Another tooltip"></a>'
    ...
    it('should convert title and content to string if numbers', () => {
      fixtureEl.innerHTML = '<RouterLink href="#" rel="tooltip"></a>'
    ...
    it('should enable selector delegation', () => {
      return new Promise(resolve => {
        ...
        containerEl.innerHTML = '<RouterLink href="#" rel="tooltip" title="Another tooltip"></a>'
    ...
    it('should create offset modifier when offset is passed as a function', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<RouterLink href="#" rel="tooltip" title="Offset from function"></a>'
    ...
    it('should create offset modifier when offset option is passed in data attribute', () => {
      fixtureEl.innerHTML = '<RouterLink href="#" rel="tooltip" data-bs-offset="10,20" title="Another tooltip"></a>'
  ...
  describe('show', () => {
    ...
    it('should show a tooltip when hovering a child element', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<RouterLink href="#" rel="tooltip" title="Another tooltip">',
    ...
    it('should throw an error the element is not visible', () => {
      fixtureEl.innerHTML = '<RouterLink href="#" style="display: none" rel="tooltip" title="Another tooltip"></a>'
    ...
    it('should not hide tooltip if leave event occurs and enter event occurs within the hide delay', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<RouterLink href="#" rel="tooltip" title="Another tooltip" data-bs-delay=\'{"show":0,"hide":150}\'>'
    ...
    it('should properly maintain tooltip state if leave event occurs and enter event occurs during hide transition', () => {
      return new Promise(resolve => {
        ...
        fixtureEl.innerHTML = '<RouterLink href="#" rel="tooltip" title="Another tooltip" data-bs-placement="top" style="position:fixed;left:50%;top:50%;">Trigger</a>'
    ...
    it('should show a tooltip with custom class provided in data attributes', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<RouterLink href="#" rel="tooltip" title="Another tooltip" data-bs-custom-class="custom-class"></a>'
  ...
  describe('_isWithContent', () => {
    ...
    it('should return false if there is no content', () => {
      fixtureEl.innerHTML = '<RouterLink href="#" rel="tooltip" title=""></a>'
  ...
  describe('setContent', () => {
    ...
    it('should re-show tip if it was already shown', () => {
      fixtureEl.innerHTML = '<RouterLink href="#" rel="tooltip" data-bs-title="Another tooltip"></a>'
  ...
  describe('aria-label', () => {
    ...
    it('should add the aria-label attribute when element text content is a whitespace string', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<RouterLink href="#" rel="tooltip" title="A tooltip"><span>    </span></a>'
    ...
    it('should not add the aria-label attribute if the attribute already exists', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<RouterLink href="#" rel="tooltip" aria-label="Different label" title="Another tooltip"></a>'
    ...
    it('should not add the aria-label attribute if the element has text content', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<RouterLink href="#" rel="tooltip" title="Another tooltip">text content</a>'
