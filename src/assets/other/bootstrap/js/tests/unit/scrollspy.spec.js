...
describe('ScrollSpy', () => {
  ...
  const getDummyFixture = () => {
    return [
      ...
      '  <ul class="nav">',
      '    <li class="nav-item"><RouterLink id="li-jsm-1" class="nav-link" href="#div-jsm-1">div 1</a></li>',
      '  </ul>',
      '</nav>',
  ...
  describe('constructor', () => {
    ...
    it('should null, if element is not scrollable', () => {
      fixtureEl.innerHTML = [
        ...
        '  <ul class="navbar-nav">' +
        '     <li class="nav-item"><RouterLink class="nav-link active" id="one-link" href="#">One</a></li>' +
        '  </ul>',
        '</nav>',
        '<div id="content">',
    ...
    it('should respect threshold option', () => {
      fixtureEl.innerHTML = [
        ...
        '   <RouterLink class="nav-link active" id="one-link" href="#">One</a>' +
        '</ul>',
        '<div id="content">',
    ...
    it('should not take count to not visible sections', () => {
      fixtureEl.innerHTML = [
        '<nav id="navigation" class="navbar">',
        '  <ul class="navbar-nav">',
        '    <li class="nav-item"><RouterLink class="nav-link active" id="one-link" href="#one">One</a></li>',
        '    <li class="nav-item"><RouterLink class="nav-link" id="two-link" href="#two">Two</a></li>',
        '    <li class="nav-item"><RouterLink class="nav-link" id="three-link" href="#three">Three</a></li>',
        '  </ul>',
        '</nav>',
    ...
    it('should only switch "active" class on current target', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '        <ul class="nav">',
          '          <li class="nav-item"><RouterLink href="#masthead">Overview</a></li>',
          '          <li class="nav-item"><RouterLink href="#detail">Detail</a></li>',
          '        </ul>',
          '      </div>',
          '    </div>',
          '  </div>',
    ...
    it('should not process data if `activeTarget` is same as given target', () => {
      return new Promise((resolve, reject) => {
        fixtureEl.innerHTML = [
          '<nav class="navbar">',
          '  <ul class="nav">',
          '    <li class="nav-item"><RouterLink class="nav-link" id="a-1" href="#div-1">div 1</a></li>',
          '    <li class="nav-item"><RouterLink class="nav-link" id="a-2" href="#div-2">div 2</a></li>',
          '  </ul>',
          '</nav>',
    ...
    it('should add to nav the active class to the correct element (nav markup)', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<nav class="navbar">',
          '  <nav class="nav">',
          '    <RouterLink class="nav-link" id="a-1" href="#div-1">div 1</a>',
          '    <RouterLink class="nav-link" id="a-2" href="#div-2">div 2</a>',
          '  </nav>',
          '</nav>',
          '<div class="content" style="overflow: auto; height: 50px">',
          '  <div id="div-1" style="height: 100px; padding: 0; margin: 0">div 1</div>',
    ...
    it('should add to list-group, the active class to the correct element (list-group markup)', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '    <RouterLink class="list-group-item" id="a-1" href="#div-1">div 1</a>',
          '    <RouterLink class="list-group-item" id="a-2" href="#div-2">div 2</a>',
          '  </div>',
          '</nav>',
          '<div class="content" style="overflow: auto; height: 50px">',
          '  <div id="div-1" style="height: 100px; padding: 0; margin: 0">div 1</div>',
    ...
    it('should clear selection if above the first section', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '<nav id="navigation" class="navbar">',
          '  <ul class="navbar-nav">',
          '    <li class="nav-item"><RouterLink id="one-link"   class="nav-link active" href="#one">One</a></li>',
          '    <li class="nav-item"><RouterLink id="two-link"   class="nav-link" href="#two">Two</a></li>',
          '    <li class="nav-item"><RouterLink id="three-link" class="nav-link" href="#three">Three</a></li>',
          '  </ul>',
          '</nav>',
          '<div id="content" style="height: 200px; overflow-y: auto;">',
    ...
    it('should correctly select navigation element on backward scrolling when each target section height is 100%', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<nav class="navbar">',
          '  <ul class="nav">',
          '    <li class="nav-item"><RouterLink id="li-100-1" class="nav-link" href="#div-100-1">div 1</a></li>',
          '    <li class="nav-item"><RouterLink id="li-100-2" class="nav-link" href="#div-100-2">div 2</a></li>',
          '    <li class="nav-item"><RouterLink id="li-100-3" class="nav-link" href="#div-100-3">div 3</a></li>',
          '    <li class="nav-item"><RouterLink id="li-100-4" class="nav-link" href="#div-100-4">div 4</a></li>',
          '    <li class="nav-item"><RouterLink id="li-100-5" class="nav-link" href="#div-100-5">div 5</a></li>',
          '  </ul>',
          '</nav>',
  ...
  describe('SmoothScroll', () => {
    ...
    it('should not smoothScroll to element if it not handles a scrollspy section', () => {
      fixtureEl.innerHTML = [
        '<nav id="navBar" class="navbar">',
        '  <ul class="nav">',
        '    <RouterLink id="anchor-1" href="#div-jsm-1">div 1</a></li>',
        '    <RouterLink id="anchor-2" href="#foo">div 2</a></li>',
        '  </ul>',
        '</nav>',
        '<div class="content" data-bs-target="#navBar" style="overflow-y: auto">',
        '  <div id="div-jsm-1">div 1</div>',
