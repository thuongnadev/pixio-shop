...
describe('Popover', () => {
  ...
  describe('show', () => {
    it('should show a popover', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<RouterLink href="#" title="Popover" data-bs-content="https://twitter.com/getbootstrap">BS twitter</a>'
    ...
    it('should set title and content from functions', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<RouterLink href="#">BS twitter</a>'
    ...
    it('should show a popover with just content without having header', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<RouterLink href="#">Nice link</a>'
    ...
    it('should show a popover with just title without having body using data-attribute to get config', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<RouterLink href="#" data-bs-content="" title="Title which does not require content">Nice link</a>'
    ...
    it('should NOT show a popover without `title` and `content`', () => {
      fixtureEl.innerHTML = '<RouterLink href="#" data-bs-content="" title="">Nice link</a>'
    ...
    it('"setContent" should keep the initial template', () => {
      fixtureEl.innerHTML = '<RouterLink href="#" title="Popover" data-bs-content="https://twitter.com/getbootstrap" data-bs-custom-class="custom-class">BS twitter</a>'
  ...
  describe('jQueryInterface', () => {
    ...
    it('should create a popover with a config object', () => {
      fixtureEl.innerHTML = '<RouterLink href="#" title="Popover">BS twitter</a>'
