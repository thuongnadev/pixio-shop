...
describe('Collapse', () => {
  ...
  describe('constructor', () => {
    ...
    it('should allow jquery object in parent config', () => {
      fixtureEl.innerHTML = [
        ...
        '  <div class="item">',
        '    <RouterLink data-bs-toggle="collapse" href="#">Toggle item</a>',
    ...
    it('should find collapse children if they have collapse class too not only data-bs-parent', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div class="my-collapse">',
          '  <div class="item">',
          '    <RouterLink data-bs-toggle="collapse" href="#">Toggle item 1</a>',
          '    <div id="collapse1" class="collapse show">Lorem ipsum 1</div>',
          '  </div>',
          '  <div class="item">',
          '    <RouterLink id="triggerCollapse2" data-bs-toggle="collapse" href="#">Toggle item 2</a>',
  ...
  describe('data-api', () => {
    it('should prevent url change if click on nested elements', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<RouterLink role="button" data-bs-toggle="collapse" class="collapsed" href="#collapse">',
          '  <span id="nested"></span>',
          '</a>',
    ...
    it('should show multiple collapsed elements', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<RouterLink role="button" data-bs-toggle="collapse" class="collapsed" href=".multi"></a>',
    ...
    it('should hide multiple collapsed elements', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<RouterLink role="button" data-bs-toggle="collapse" href=".multi"></a>',
    ...
    it('should remove "collapsed" class from target when collapse is shown', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<RouterLink id="link1" role="button" data-bs-toggle="collapse" class="collapsed" href="#" data-bs-target="#test1"></a>',
          '<RouterLink id="link2" role="button" data-bs-toggle="collapse" class="collapsed" href="#" data-bs-target="#test1"></a>',
          '<div id="test1"></div>'
        ].join('')
    ...
    it('should add "collapsed" class to target when collapse is hidden', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<RouterLink id="link1" role="button" data-bs-toggle="collapse" href="#" data-bs-target="#test1"></a>',
          '<RouterLink id="link2" role="button" data-bs-toggle="collapse" href="#" data-bs-target="#test1"></a>',
    ...
    it('should allow accordion to use children other than card', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div id="accordion">',
          '  <div class="item">',
          '    <RouterLink id="linkTrigger" data-bs-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"></a>',
          '    <div id="collapseOne" class="collapse" role="tabpanel" data-bs-parent="#accordion"></div>',
          '  </div>',
          '  <div class="item">',
          '    <RouterLink id="linkTriggerTwo" data-bs-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"></a>',
    ...
    it('should allow accordion to target multiple elements', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div id="accordion">',
          '  <RouterLink id="linkTriggerOne" data-bs-toggle="collapse" data-bs-target=".collapseOne" href="#" aria-expanded="false" aria-controls="collapseOne"></a>',
          '  <RouterLink id="linkTriggerTwo" data-bs-toggle="collapse" data-bs-target=".collapseTwo" href="#" aria-expanded="false" aria-controls="collapseTwo"></a>',
    ...
    it('should collapse accordion children but not nested accordion children', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '        <div class="item">',
          '          <RouterLink id="nestedLinkTrigger" data-bs-toggle="collapse" href="#nestedCollapseOne" aria-expanded="false" aria-controls="nestedCollapseOne"></a>',
    ...
    it('should add "collapsed" class and set aria-expanded to triggers only when all the targeted collapse are hidden', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<RouterLink id="trigger1" role="button" data-bs-toggle="collapse" href="#test1"></a>',
          '<RouterLink id="trigger2" role="button" data-bs-toggle="collapse" href="#0/my/id"></a>',
          '<RouterLink id="trigger3" role="button" data-bs-toggle="collapse" href=".multi"></a>',
