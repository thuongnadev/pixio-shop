  ...
  <div :class="`sticky-header main-bar-wraper navbar-expand-lg  ${isFixed ? 'is-fixed' : ''}`">
    <div class="main-bar clearfix">
      <div class="container-fluid clearfix d-lg-flex d-block">
        ...
        <!-- Main Nav -->
        <div :class="`header-nav w3menu navbar-collapse justify-content-end w3menu ${isMenu ? 'show' : ''}`" id="navbarNavDropdown">
          ...
          <ul class="nav navbar-nav">
                        ...
                        <ul>
                          ...
                          <li>
                            <RouterLink to="/forget-password"
                              >Forget Password
                              <div class="badge badge-sm rounded badge-animated">New</div></RouterLink
                            >
                          </li>
                        </ul>
                      </li>
            ...
            <li class="sub-menu-down menu-right">
              <RouterLink to=""><span>Menu</span><i class="fas fa-chevron-down tabindex"></i></RouterLink>
              <ul class="sub-menu">
